...
//struct bpf_map packet_map_template0 SEC(".maps"), packet_map_template1 SEC(".maps"), packet_map_template2 SEC(".maps"), packet_map_template3 SEC(".maps"), packet_map_template4 SEC(".maps"), packet_map_template5 SEC(".maps"), packet_map_template6 SEC(".maps"), packet_map_template7 SEC(".maps"), packet_map_template8 SEC(".maps"), packet_map_template9 SEC(".maps"), packet_map_template10 SEC(".maps"), packet_map_template11 SEC(".maps"), packet_map_template12 SEC(".maps"), packet_map_template13 SEC(".maps"), packet_map_template14 SEC(".maps"), packet_map_template15 SEC(".maps"), packet_map_template16 SEC(".maps"), packet_map_template17 SEC(".maps"), packet_map_template18 SEC(".maps"), packet_map_template19 SEC(".maps"), packet_map_template20 SEC(".maps"), packet_map_template21 SEC(".maps"), packet_map_template22 SEC(".maps"), packet_map_template23 SEC(".maps"), packet_map_template24 SEC(".maps"), packet_map_template25 SEC(".maps"), packet_map_template26 SEC(".maps"), packet_map_template27 SEC(".maps"), packet_map_template28 SEC(".maps"), packet_map_template29 SEC(".maps"), packet_map_template30 SEC(".maps"), packet_map_template31 SEC(".maps"), packet_map_template32 SEC(".maps"), packet_map_template33 SEC(".maps"), packet_map_template34 SEC(".maps"), packet_map_template35 SEC(".maps"), packet_map_template36 SEC(".maps"), packet_map_template37 SEC(".maps"), packet_map_template38 SEC(".maps"), packet_map_template39 SEC(".maps"), packet_map_template40 SEC(".maps"), packet_map_template41 SEC(".maps"), packet_map_template42 SEC(".maps"), packet_map_template43 SEC(".maps"), packet_map_template44 SEC(".maps"), packet_map_template45 SEC(".maps"), packet_map_template46 SEC(".maps"), packet_map_template47 SEC(".maps"), packet_map_template48 SEC(".maps"), packet_map_template49 SEC(".maps");
struct bpf_map packet_map_template0 SEC(".maps"), packet_map_template1 SEC(".maps"), packet_map_template2 SEC(".maps"), packet_map_template3 SEC(".maps"), packet_map_template4 SEC(".maps"), packet_map_template5 SEC(".maps"), packet_map_template6 SEC(".maps"), packet_map_template7 SEC(".maps"), packet_map_template8 SEC(".maps"), packet_map_template9 SEC(".maps"), packet_map_template10 SEC(".maps"), packet_map_template11 SEC(".maps"), packet_map_template12 SEC(".maps"), packet_map_template13 SEC(".maps"), packet_map_template14 SEC(".maps"), packet_map_template15 SEC(".maps"), packet_map_template16 SEC(".maps"), packet_map_template17 SEC(".maps"), packet_map_template18 SEC(".maps"), packet_map_template19 SEC(".maps");
...
/* 
        ...
        bpf_map_push_elem(&packet_map_template10, pinfo, BPF_ANY);
    } else if (hash_idx == 11) {
        bpf_map_push_elem(&packet_map_template11, pinfo, BPF_ANY);
    } else if (hash_idx == 12) {
        bpf_map_push_elem(&packet_map_template12, pinfo, BPF_ANY);
    } else if (hash_idx == 13) {
        bpf_map_push_elem(&packet_map_template13, pinfo, BPF_ANY);
    } else if (hash_idx == 14) {
        bpf_map_push_elem(&packet_map_template14, pinfo, BPF_ANY);
    } else if (hash_idx == 15) {
        bpf_map_push_elem(&packet_map_template15, pinfo, BPF_ANY);
    } else if (hash_idx == 16) {
        bpf_map_push_elem(&packet_map_template16, pinfo, BPF_ANY);
    } else if (hash_idx == 17) {
        bpf_map_push_elem(&packet_map_template17, pinfo, BPF_ANY);
    } else if (hash_idx == 18) {
        bpf_map_push_elem(&packet_map_template18, pinfo, BPF_ANY);
    } else if (hash_idx == 19) {
        bpf_map_push_elem(&packet_map_template19, pinfo, BPF_ANY);
    }
*/
}
